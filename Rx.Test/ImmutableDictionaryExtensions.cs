...
namespace Rx.Test
{
    ...
    {
        public static ImmutableDictionary<TKey, TValue> Dict<TKey, TValue>(TKey key, TValue value)
        {
        ...
        public static ImmutableDictionary<TKey, TValue> AddOrUpdate<TKey, TValue>(
            ...
            TKey key, TValue add, Func<TValue, TValue> update)
        {
        ...
        public static bool StructuralEquals<TKey, TValue>(
            ...
            ImmutableDictionary<TKey, TValue> o2)
        {
